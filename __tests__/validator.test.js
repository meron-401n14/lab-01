...
describe('Validator module evaluates a basic schema', () => {
  it('isValid() validates a good record', () => {
    ...
    for (var field in schema.fields) {
      ...
      case 'boolean':
        testRecord[field] = faker.random.boolean(); //faker
        break;
      case 'number':
        testRecord[field] = faker.random.number(); //faker
        break;
      case 'string':
        testRecord[field] = faker.random.words(); //faker
        break;
      case 'array':
        testRecord[field] = [];
        testRecord[field].push(faker.random.arrayElement()); //faker
        testRecord[field].push(faker.random.arrayElement()); //faker
        break;
      default:
        null;
