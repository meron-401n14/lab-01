  ...
  it("isValid() validates a good record", () => {
    ...
    for (var field in schema.fields) {
      switch (schema.fields[field].type) {
        case "boolean":
          testRecord[field] = validator.random.boolean(); //faker
          break;
        case "number":
          testRecord[field] = validator.random.number(); //faker
          break;
        case "string":
          testRecord[field] = validator.random.word();  //faker
          break;
        case "array":
          testRecord[field] = [];
          testRecord[field].push(validator.random.arrayElement());  //faker
          testRecord[field].push(validator.random.arrayElement()); //faker
          break;
        default:
          null;
